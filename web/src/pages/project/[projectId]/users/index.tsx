    ...
    <Page
      headerProps={{
        ...
        help: {
          description: (
            <>
              Attribute data in btrace to a user by adding a userId to your
              traces. See{" "}
              <a
  ...
  const columns: LangfuseColumnDef<RowData>[] = [
    {
      ...
      headerTooltip: {
        description:
          "The unique identifier for the user that was logged in btrace. See docs for more details on how to set this up.",
        href: "https://langfuse.com/docs/observability/features/users",
      },
      size: 150,
      cell: ({ row }) => {
