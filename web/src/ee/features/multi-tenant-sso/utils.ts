// @ts-nocheck
import { z } from "zod";
import { type Provider } from "@/src/hooks/useAuth";
import GoogleProvider from "@/src/hooks/useAuth";
import GitHubProvider from "@/src/hooks/useAuth";
import GitLabProvider from "@/src/hooks/useAuth";
import OktaProvider from "@/src/hooks/useAuth";
import AuthentikProvider from "@/src/hooks/useAuth";
import OneLoginProvider from "@/src/hooks/useAuth";
import CognitoProvider from "@/src/hooks/useAuth";
import KeycloakProvider from "@/src/hooks/useAuth";
import Auth0Provider from "@/src/hooks/useAuth";
import AzureADProvider from "@/src/hooks/useAuth";
