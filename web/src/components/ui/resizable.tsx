...
function ResizablePanelGroup({
  ...
  // suppressHydrationWarning: react-resizable-panels uses useId() which
  // generates different data-testid/id on server vs client in Turbopack.
  // This causes a recoverable hydration warning (React regenerates the
  // tree on client) but does not affect functionality.
  return (
