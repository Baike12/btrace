...
/** Render children only on the client, avoiding hydration mismatches from
 *  libraries (like react-resizable-panels) that use useId() which differs
 *  between server and client in Turbopack. */
