...
const OrganizationProjectTiles = ({
  ...
  org: NonNullable<User["organizations"]>[number];
  search?: string;
}) => {
  return (
...
const DemoOrganizationTile = () => {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Try btrace Demo</CardTitle>
      </CardHeader>
      <CardContent>
        We have built a Q&A chatbot that answers questions based on the upstream
        docs. Interact with it to see traces in btrace.
      </CardContent>
      <CardFooter>
        <Button asChild variant="secondary">
          <Link
      ...
      <CardContent>
        <CardDescription>
          {canCreateOrgs
            ...
            : "You need to get invited to an organization to get started with btrace."}
        </CardDescription>
      </CardContent>
