...
/**
 * Informational, dismissible banner that highlights btrace's support for AI
 * coding agents via the Agent Skill and CLI. Rendered on the organization
 * overview page.
 */
      ...
      <div className="flex items-center gap-2">
        ...
        <span>
          <span className="font-semibold">
            btrace works great with your AI coding agents.
          </span>{" "}
