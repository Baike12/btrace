...
This guide walks you through setting up and testing the btrace Slack integration for local development.
...
2. Upload the btrace icon from `web/public/icon512.png` as your app's avatar
...
1. Navigate to your btrace project settings
...
- **Direct links**: Jump from Slack messages directly to prompts in btrace
