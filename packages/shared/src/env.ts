...
const EnvSchema = z.object({
  ...
  REDIS_HOST: z.string().nullish().optional(),
  REDIS_PORT: z.coerce
  ...
  REDIS_CONNECTION_STRING: z.string().nullish().optional(),
  ...
  LANGFUSE_S3_UPLOAD_MAX_CONCURRENT_PARTS: z.coerce
    ...
    .max(10)
    .default(3),
  LANGFUSE_S3_EVENT_UPLOAD_BUCKET: z.string().optional(), // S3 removed for PG-only
