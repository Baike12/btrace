...
export const OBSERVATIONS_TO_TRACE_INTERVAL = "2 DAYS";
// observation.start_time > t.timestamp - 1 hour
export const TRACE_TO_OBSERVATIONS_INTERVAL = "1 HOUR";
// observation.start_time > s.timestamp - 1 hour
// t.timestamp > s.timestamp - 1 hour
export const SCORE_TO_TRACE_OBSERVATIONS_INTERVAL = "1 HOUR";
