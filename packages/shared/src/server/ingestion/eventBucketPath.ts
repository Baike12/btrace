// @ts-nocheck
import { env } from "../../env";
// PG-only: local type stub (ClickHouse schemaUtils removed)
type IngestionEntityTypes = "trace" | "observation" | "score";
const safeBlobKeySegment = (s: string) => s; // PG-only stub
